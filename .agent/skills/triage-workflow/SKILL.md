...
Read the issue body, comments, linked PRD, related `.scratch/` board, relevant code, tests, `CONTEXT.md`, and ADRs.
...
- Relevant constraints from PRDs, ADRs, or domain docs
...
- `domain-modeling` sharpens language and ADRs
