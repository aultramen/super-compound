...
- **Capture gate:** Save useful decisions to `docs/brainstorms/YYYY-MM-DD-<topic>-brainstorm.md` with purpose, rationale, alternatives, decisions, open questions, and recommended next workflow. Name non-goals explicitly.
