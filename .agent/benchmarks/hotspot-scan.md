...
| full agentic templates | 95066 | 1416 | 98.51% | `.agent/context/template-index.md`, skeletons |
| all skills | 52186 | 594 | 98.86% | `.agent/context/skill-index.md` |
...
| agent prompts | 5442 | 99 | 98.18% | `.agent/context/agent-index.md` |
| hooks | 4559 | 104 | 97.72% | `.agent/context/hook-index.md` |
| all workflows | 4022 | 141 | 96.49% | `.agent/context/workflow-dispatch.md` |
| all rules | 1925 | 94 | 95.12% | `.agent/context/rule-index.md` |
